...
class Developer
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="HDW\MySQLBundle\Entity\City", cascade={"persist"})
     ...
     * Set city
     *
     * @param \HDW\MySQLBundle\Entity\City $city
     *
     * @return Developer
     */
    public function setCity(\HDW\MySQLBundle\Entity\City $city)
    {
        $this->city = $city;
     ...
     * Get city
     *
     * @return \HDW\MySQLBundle\Entity\City
     */
